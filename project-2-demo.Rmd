...
## Setup
In this block are needed libraries for work. Workdir is set to my folder on my computer. For running this notebook I used  R version 4.1.2. All work is done here, except figure 1 was done in seperate script called Plot1.R. First data preprocesing (editing some .csv lines that pandas and R could not load) is in added jupyter notebook. Also some more data preprocesing was done in jupyter notebook due to lack of tehnical cnowladge of R. In parts when I switched to jupyter notebook there is written sign to go to jupyter notebook do work there and then go back here.
...
ggplot(time_series_1, aes(x=Date, y=Days_since, colour=Version)) +
  ...
  scale_x_date(date_labels="%b %y",date_breaks  ="1 month") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
